...
if page == "Home":
    ...
    st.markdown(
        '<div class="big-title">ATHARV Prescription Assistant</div>',
        unsafe_allow_html=True
    )
    ...
    if uploaded:
        ...
        with col2:
            ...
            if medicines:
                ...
                st.info(
                    "Now go to Step 2 for a simple explanation."
                )
...
# ──────────────────────────────────────────────
    ...
    for med in medicines:
        ...
        table_data.append({
            ...
            'Morning': (
                'Yes'
                if len(parts) > 0 and parts[0].strip() == '1'
                else '—'
            ),
            'Afternoon': (
                'Yes'
    ...
    if packaging_file:
        ...
        with col2:
            ...
            if detected:
                ...
                st.markdown(
                    f"Detected medicine name: `{detected}`"
                )
                ...
                if matched and score >= 85:
                    ...
                    st.markdown(
                        ...
                        f'<b>PLEASE DOUBLE CHECK</b><br><br>'
                    ...
                    st.markdown(
                        ...
                        f'Please do NOT take this medicine.<br>'
...
# ──────────────────────────────────────────────
    ...
    if st.button("Get Answer"):
        ...
        if user_question.strip():
            ...
            with st.spinner(
                "Finding answer — usually 3 to 5 seconds..."
            ):
